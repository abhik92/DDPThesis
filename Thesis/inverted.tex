...
where 	$\rho$ is the minimum  number of features present in any point containing atleast one of the features pruned uptil now i.e $\rho = \min\limits_{k\in R} V_k$
